        ...
        <div className="max-w-4xl mx-auto text-center pt-16 sm:pt-0">
          ...
          <div className="flex flex-col sm:flex-row gap-5 justify-center items-center">
            <Link href="/allClasses">
              <button type="button" className="group relative bg-emerald-600 hover:bg-emerald-500 text-white px-8 py-4 rounded-full font-bold text-lg transition-all duration-300 transform hover:scale-105 hover:text-black hover:shadow-2xl hover:shadow-emerald-500/20 overflow-hidden">
            ...
            <Link href="https://youtu.be/Sm8O9Lcnr7o?si=-xBc7pWkuUAgAnU1" target="_blank">
              <button type="button" className="group flex items-center gap-3 bg-zinc-800/40 backdrop-blur-sm hover:bg-zinc-800/60 text-white px-6 py-4 rounded-full font-semibold transition-all duration-300 border border-zinc-700 hover:border-emerald-500/50">
