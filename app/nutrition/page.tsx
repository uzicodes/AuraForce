    ...
    return (
      ...
      <div className="min-h-screen relative flex items-center justify-center p-4 overflow-hidden">
        ...
        <div className="relative z-10 max-w-md w-full bg-zinc-900/80 backdrop-blur-md border border-yellow-500/30 rounded-3xl p-8 text-center shadow-2xl">
          ...
          <h2 className="text-2xl font-bold text-white mb-2 font-heading">Missing Body Stats</h2>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-1 space-y-6">
            <div className="bg-zinc-900/80 backdrop-blur-md border border-zinc-800/50 rounded-3xl p-6 shadow-lg">
              <h3 className="text-xl font-bold text-white mb-4 flex items-center gap-2 font-heading"><FaDumbbell className="text-emerald-500" /> Goal</h3>
              <p className="text-zinc-300 leading-relaxed font-satoshi">{selectedPlan?.goal}</p>
            </div>

            <div className="bg-zinc-900/80 backdrop-blur-md border border-zinc-800/50 rounded-3xl p-6 shadow-lg">
              <h3 className="text-xl font-bold text-white mb-4 flex items-center gap-2 font-heading"><FaLeaf className="text-emerald-500" /> Macros</h3>
          ...
          <div className="lg:col-span-2 bg-zinc-900/80 backdrop-blur-md border border-zinc-800/50 rounded-3xl p-8 shadow-lg">
            <h3 className="text-2xl font-bold text-white mb-8 flex items-center gap-3 font-heading"><FaUtensils className="text-emerald-500" /> Daily Menu</h3>
              ...
              {selectedPlan?.meals && Object.entries(selectedPlan.meals).map(([type, meal]: [string, any]) => (
                <div key={type} className="flex gap-4 sm:gap-6 group">
                  ...
                  <div className="pb-8">
                    ...
                    <h4 className="text-xl font-bold text-white mb-2 font-heading">{meal.name}</h4>
                    <p className="text-zinc-400 text-sm mb-3 font-satoshi">{meal.desc}</p>
